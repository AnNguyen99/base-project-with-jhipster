package com.rikkei.gateway.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public Mono<ResponseEntity<Problem>> handleEmailAlreadyUsedException(
        com.rikkei.gateway.service.EmailAlreadyUsedException ex,
    ...
    public Mono<ResponseEntity<Problem>> handleUsernameAlreadyUsedException(
        com.rikkei.gateway.service.UsernameAlreadyUsedException ex,
        ServerWebExchange request
    ) {
    ...
    public Mono<ResponseEntity<Problem>> handleInvalidPasswordException(
        com.rikkei.gateway.service.InvalidPasswordException ex,
        ServerWebExchange request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.rikkei.gateway");
    }
}
